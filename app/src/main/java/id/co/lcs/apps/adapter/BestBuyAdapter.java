...
import id.co.lcs.apps.databinding.RowViewListBestBuyBinding;
import id.co.lcs.apps.databinding.RowViewListProductBinding;
import id.co.lcs.apps.databinding.RowViewWishlistBinding;
...
public class BestBuyAdapter extends RecyclerView.Adapter<BestBuyAdapter.DataObjectHolder> {
    private ArrayList<Product> mDataSet;
    private BestBuyFragment mContext;
    private DecimalFormatSymbols otherSymbols;
    private DecimalFormat format;

    public BestBuyAdapter(BestBuyFragment context, ArrayList<Product> data) {
        mDataSet = data;
        mContext = context;
    }

    class DataObjectHolder extends RecyclerView.ViewHolder {
        private RowViewListBestBuyBinding binding;

        DataObjectHolder(@NonNull RowViewListBestBuyBinding binding) {
    ...
    public DataObjectHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new DataObjectHolder(RowViewListBestBuyBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    }

    @Override
    public void onBindViewHolder(@NonNull final BestBuyAdapter.DataObjectHolder holder, final int position) {
        ...
        holder.binding.txtPrice.setText("Total Sales $" + data.getSalesAmt());
