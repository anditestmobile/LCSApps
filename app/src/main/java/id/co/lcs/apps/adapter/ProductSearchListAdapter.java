...
public class ProductSearchListAdapter extends RecyclerView.Adapter<ProductSearchListAdapter.DataObjectHolder> {
    private ArrayList<Product> mDataSet;
    private ProductSearchListActivity mContext;
    private DecimalFormatSymbols otherSymbols;
    private DecimalFormat format;

    public ProductSearchListAdapter(ProductSearchListActivity context, ArrayList<Product> data) {
        mDataSet = data;
        mContext = context;
    }
